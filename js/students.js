...
const StudentsManager = {
  ...
  currentGradeFilter: 'all', // 'all', '초4'~'초6', '중1'~'중3', '고1'~'고3'
  searchKeyword: '',
  ...
  updateModalGradeOptions(selectedGrade = '') {
    ...
    const grades = window.getGradesForLevel ? window.getGradesForLevel(level) : (level === '초등' ? ['초4', '초5', '초6'] : level === '중등' ? ['중1', '중2', '중3'] : ['고1', '고2', '고3']);
  ...
  openAddModal() {
    ...
    this.updateModalGradeOptions('초4');
